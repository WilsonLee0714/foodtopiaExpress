...
.get(function(req, res){
    ...
    connection.query(
        'SELECT `menu01`.*, `members`.`nick_name` FROM `members` JOIN `menu01` ON `menu01`.`member_id`=`members`.`sid` WHERE `country_id`=?',req.params.id, function(error,results){
            // console.log(results)
        if(error) throw error;
        res.json(results);
...
.get(function(req, res){
    ...
    // var subCateId = [ 'country_id', 'serving_id', 'occasion_id', 'difficult_id', 'time_id' ] 
    connection.query(
        'SELECT `menu01`.*, `members`.`nick_name` FROM `members` JOIN `menu01` ON `menu01`.`member_id`=`members`.`sid` WHERE `occasion_id`=?',req.params.id, function(error,results){
            // console.log(results)
        if(error) throw error;
        res.json(results);
        // console.log(req.params.id)
...
.get(function(req, res){
    ...
    // var subCateId = [ 'country_id', 'serving_id', 'occasion_id', 'difficult_id', 'time_id' ] 
    connection.query(
        'SELECT `menu01`.*, `members`.`nick_name` FROM `members` JOIN `menu01` ON `menu01`.`member_id`=`members`.`sid` `serving_id`=?',req.params.id, function(error,results){
            // console.log(results)
        if(error) throw error;
        res.json(results);
        // console.log(req.params.id)
...
.get(function(req, res){
    ...
    // var subCateId = [ 'country_id', 'serving_id', 'occasion_id', 'difficult_id', 'time_id' ] 
    connection.query(
        'SELECT `menu01`.*, `members`.`nick_name` FROM `members` JOIN `menu01` ON `menu01`.`member_id`=`members`.`sid` WHERE `difficult_id`=?',req.params.id, function(error,results){
            // console.log(results)
        if(error) throw error;
        res.json(results);
        // console.log(req.params.id)
...
.get(function(req, res){
    ...
    // var subCateId = [ 'country_id', 'serving_id', 'occasion_id', 'difficult_id', 'time_id' ] 
    connection.query(
        'SELECT `menu01`.*, `members`.`nick_name` FROM `members` JOIN `menu01` ON `menu01`.`member_id`=`members`.`sid` WHERE `time_id`=?',req.params.id, function(error,results){
            // console.log(results)
        if(error) throw error;
        res.json(results);
        // console.log(req.params.id)
